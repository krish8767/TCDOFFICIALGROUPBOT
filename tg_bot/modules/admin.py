...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("I can't promote myself! Get an admin to do it for me.U lazy boy")
        return ""
    ...
    message.reply_text("promoted,now he is ready to F##K🧡")
    return "<b>{}:</b>" \
           "\n#PROMOTED" \
           "\n<b>Admin:</b> {}" \
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'creator':
        message.reply_text("i cant ban creator of the group.... 😬,BUT I CAN BAN U FOR SURE")
        return ""

    if not user_member.status == 'administrator':
        message.reply_text("Can't demote what wasn't promoted!,U NIGGA")
        return ""

    if user_id == bot.id:
        message.reply_text("I can't demote myself! Get an admin to do it for me.U LAZY BOY")
        return ""
